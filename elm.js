	...
	function (msg, model) {
		...
		switch (_p1.ctor) {
			...
			case 'StartGame':
				...
				var numberOfClients = _p3._0;
				var numberOfFraudsters = _p3._1;
				var rows = _p3._2;
				var clientRandomList = function () {
					var _p5 = updatedModel.startedTime;
					if (_p5.ctor === 'Just') {
						return A4(
							...
							1,
							rows * rows,
							_elm_lang$core$Basics$floor(_p5._0));
					} else {
						return {ctor: '[]'};
					}
				}();
				var fraudsterRandomList = function () {
					...
					if (_p6.ctor === 'Just') {
						return A4(
							...
							1,
							rows * rows,
							_elm_lang$core$Basics$floor(_p6._0 / 2));
					} else {
						return {ctor: '[]'};
					}
				}();
